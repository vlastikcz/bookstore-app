...
public class BookSearchRepository {
    ...
    @NonNull
    public Page<BookEntity> search(@Nullable String titleQuery,
        ...
        Query dataQuery = entityManager.createNativeQuery(dataSql, BookEntity.class);
        applyParameters(dataQuery, parameters);
        dataQuery.setFirstResult((int) pageable.getOffset());
        dataQuery.setMaxResults(pageable.getPageSize());

        @SuppressWarnings("unchecked")
        List<BookEntity> content = dataQuery.getResultList();
